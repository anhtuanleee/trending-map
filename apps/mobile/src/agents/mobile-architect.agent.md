...
- Put remote calls in feature `api` modules, configured clients in named `lib` capabilities, and TanStack Query orchestration in feature hooks.
...
2. Identify the route, screen/feature, domain hook, API module, configured client, and contract impact.
