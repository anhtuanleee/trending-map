...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, justifyContent: 'center', paddingVertical: spacing.xxxl },
  iconWrap: {
    width: 64,
    height: 64,
  ...
  description: { marginTop: spacing.md, color: colors.inkMuted, fontSize: 15, lineHeight: 23 },
  googleButton: {
    marginTop: spacing.xl,
    minHeight: 56,
    alignItems: 'center',
  ...
  googleButtonText: { color: colors.onPrimary, fontSize: 16, fontWeight: '800' },
  ...
  label: { marginTop: spacing.xl, color: colors.ink, fontSize: 13, fontWeight: '700' },
  input: {
    marginTop: spacing.sm,
    minHeight: 54,
    borderWidth: 1,
