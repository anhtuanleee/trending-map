...
insert into public.reports (
  ...
  geometry, address_label, starts_at, expires_at, confirmation_count
) values (
  ...
  'Nguyễn Huệ, Bến Nghé, Quận 1', now() - interval '8 minutes', now() + interval '2 hours', 14
), (
  ...
  'Hai Bà Trưng, Quận 1', now() - interval '30 minutes', now() + interval '30 days', 1
), (
  ...
  'Công viên Bến Bạch Đằng, Quận 1', now() + interval '4 hours', now() + interval '8 hours', 32
)
on conflict (id) do nothing;
